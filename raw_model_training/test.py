...
def prepare_data(args):
    ...
    train_2 = np.load('/public/mount_data/data/wzw/dataset/radio{}NormTrainX.npy'.format(args.dataset))
    train_label_path = '/public/mount_data/data/wzw/dataset/radio{}NormTrainSnrY.npy'.format(args.dataset)  # 训练集标签
    ...
    test_2 = np.load('/public/mount_data/data/wzw/dataset/radio{}NormTestX.npy'.format(args.dataset))
    test_label_path = '/public/mount_data/data/wzw/dataset/radio{}NormTestSnrY.npy'.format(args.dataset)  # 训练集标签
...
def arg_parse():
    ...
    parser.set_defaults(lr=0.001, batch_size=128, num_epochs=1, num_workers=8, dataset='128', model='CNN1D')
