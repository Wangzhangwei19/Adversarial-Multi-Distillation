...
for dataset in 1024;
do
	CUDA_VISIBLE_DEVICES=2 python train.py --model CNN1D --dataset $dataset --num_workers 8 --epochs 50 &
	CUDA_VISIBLE_DEVICES=3 python train.py --model CNN2D --dataset $dataset --num_workers 8 --epochs 50 &
	CUDA_VISIBLE_DEVICES=4 python train.py --model LSTM --dataset $dataset --num_workers 8 --epochs 50 &
	...
	CUDA_VISIBLE_DEVICES=4 python train.py --model Vgg16 --dataset $dataset --num_workers 8 --epochs 50 &
